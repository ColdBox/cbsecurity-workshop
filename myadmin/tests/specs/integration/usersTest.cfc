	...
	function run(){
		...
		describe( "users Suite", function(){
			...
			it( "index", function(){
				...
				var event = get( "users.index" );
				// expectations go here.
				expect( false ).toBeTrue();
			});			it( "new", function(){
                // Execute event or route via GET http method. Spice up accordingly
				var event = get( "users.new" );
				// expectations go here.
				expect( false ).toBeTrue();
			});			it( "create", function(){
                // Execute event or route via GET http method. Spice up accordingly
				var event = get( "users.create" );
				// expectations go here.
				expect( false ).toBeTrue();
			});			it( "show", function(){
                // Execute event or route via GET http method. Spice up accordingly
                ...
                // Execute event or route via GET http method. Spice up accordingly
				var event = get( "users.edit" );
				// expectations go here.
				expect( false ).toBeTrue();
			});			it( "update", function(){
                // Execute event or route via GET http method. Spice up accordingly
				var event = get( "users.update" );
				// expectations go here.
				expect( false ).toBeTrue();
			});			it( "delete", function(){
                // Execute event or route via GET http method. Spice up accordingly
				var event = get( "users.delete" );
				// expectations go here.
				expect( false ).toBeTrue();
			});
		});
